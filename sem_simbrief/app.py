...
def enviar_para_discord():
    ...
    'Renda': f'R$ {((int(entry_dist.get()) / 450) * 250):.2f}'.replace('.', ','),
    'Gees': fpm
    }

    tempo_voo_km = int(entry_dist.get()) * 1.852
            ...
            "embeds": [
                {
                    ...
                    "fields": [ {"name": "", "value": '', "inline": False},
                               ...
                               {"name": "", "value": (
                                   ...
                                   f'**Distancia:** {mensagem["Distancia:"]} NM ≈ {tempo_voo_km} KM\n'
...
entry_briefing = ctk.CTkEntry(app, width=590, text_color='black', fg_color='lightgray', font=('Arial', 16, 'bold'), border_width=2, border_color='#B8BDB5', state="disabled")
...
btn_simbrief = ctk.CTkButton(app, text='Importar do simbrief', font=('Arial', 14, 'bold'), text_color='black', fg_color='lightgray', state="disabled")
